...
picture_domain = 'https://pbs.twimg.com/profile_images/'
picture_data_url = '2671170543/18debd694829ed78203a5a36dd364160_400x400.png'
picture = picture_domain+picture_data_url
# Create dummy user
User1 = User(username="RoboBarista",
